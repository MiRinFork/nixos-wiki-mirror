...
One may use [JACK module](https://github.com/NixOS/nixpkgs/blob/nixos-unstable/nixos/modules/services/audio/jack.nix). It works both with and without PulseAudio. Enable it this way **and reboot**:
...
4.  Configure QjackCtl
    1.  Enable jackdbus
        ...
        <figure>
        <img src="qjackctl-settings.png" title="qjackctl-settings.png" />
        <figcaption>qjackctl-settings.png</figcaption>
        </figure>

        Setup -\> Misc -\> Enable D-Bus interface: check

        <figure>
        <img src="qjackctl-misc.png" title="qjackctl-misc.png" />
        <figcaption>qjackctl-misc.png</figcaption>
        </figure>
    2.  Load the jack modules for pulseaudio after starting jackdbus
        ...
        <figure>
        <img src="qjackctl-options.png" title="qjackctl-options.png" />
        <figcaption>qjackctl-options.png</figcaption>
        </figure>
...
<figure>
<img src="kmix-pulseaudio-with-jack.png" title="kmix-pulseaudio-with-jack.png" />
<figcaption>kmix-pulseaudio-with-jack.png</figcaption>
</figure>
