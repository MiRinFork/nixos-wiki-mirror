...
- path: /etc/nixos/host.nix
  ...
  content: |
    {pkgs, ...}:
    {
      environment.systemPackages = with pkgs; [ macchina vim ];
    }
runcmd:
...
<figure>
<img src="scaleway1.png" title="Screenshot of console showing root session" />
<figcaption>Screenshot of console showing root session</figcaption>
</figure>
