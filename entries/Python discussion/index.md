...
in general see [1](http://djangotricks.blogspot.de/2008/09/note-on-python-paths.html)
...
marcweber and qknight **vote against that**. it makes packaging complicated: to mix python2 and python3? We could introduce NIX_PYTHON_SITES_2 and NIX_PYTHON_SITES_3 or such. a better way is to use load-env-whatever (see [2](http://invalidmagic.wordpress.com/2012/03/23/developing-software-using-nixos/) )
...
see **problem 2** in [3](https://web.archive.org/web/20150406220317/https://permalink.gmane.org/gmane.linux.distributions.nixos/8732)
...
as discussed in [4](http://old.nabble.com/Python-3-to22076291.html#a22119842) and quoting [5](https://nixos.org/repos/nix/nixpkgs/trunk/pkgs/development/python-modules/pygobject/default.nix)
...
so how should i package python-gudev then? the source for python-gudev (which produces the above error) can be found at [6](https://github.com/NixOS/nixpkgs/blob/master/pkgs/development/python-modules/python-gudev/default.nix)
