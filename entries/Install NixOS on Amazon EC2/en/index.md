...
<!-- Source page: Install NixOS on Amazon EC2/en -->

<languages /> Amazon EC2 is a widely used cloud deployment platform that is part of Amazon Web Services (AWS). NixOS largely supports the platform through AMIs and the [nixos-generators](https://github.com/nix-community/nixos-generators) project.
