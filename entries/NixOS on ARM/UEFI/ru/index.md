...
<!-- Source page: NixOS on ARM/UEFI/ru -->
...
В противном случае вы можете поступить как обычно: создать раздел ESP, FAT32, который будет монтироваться по адресу `/boot/`, предпочтительный раздел rootfs, своп, если хотите, и т. д.
