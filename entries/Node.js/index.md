...
Adapt or add following line to your system configuration:\<syntaxhighlight lang="nix\> environment.systemPackages = with pkgs; \[ nodejs \];

</syntaxhighlight>

See [NixOS Package Search](https://search.nixos.org/packages?&query=nodejs) for additional versions like `nodejs_20`, etc.
