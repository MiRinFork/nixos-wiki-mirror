...
to accept external connections. The first time you connect to the new server, a wizard will guide you through the remaining configuration steps. Before connecting to the new server, you may wish to optionally configure SSL or PostgreSQL.

## SSL

The Quassel server can use SSL if a certificate is provided. Install openssl (using nix-env or by adding it to
