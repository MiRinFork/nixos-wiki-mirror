...
<!-- Source page: NixOS Installation Guide/Unetbootin -->
...
1.  Download a [NixOS ISO image](https://nixos.org/download/#nixos-iso) or <a href="#Build_a_custom_installation_image" class="wikilink" title="#Build a custom installation image">#Build a custom installation image</a>.
