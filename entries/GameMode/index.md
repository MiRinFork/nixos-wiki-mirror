...
Renice & ioprio optimisations sometimes fail. This is caused by GameMode trying to apply optimisations on processes that exit before the optimisations can be applied. See [FeralInteractive/gamemode#167 (comment)](https://github.com/FeralInteractive/gamemode/issues/167#issuecomment-524277666).
