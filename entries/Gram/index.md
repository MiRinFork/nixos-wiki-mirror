...
Add `fenix` to your flake </translate>

<translate> The examples all use the stable version attribute set, but any provided by `fenix` should work.
...
If using flake parts, devShells need to have their inputs passed to them by `perSystem` rather than as a top-level attribute. The file paths are only examples and can be replaced to fit the structure of your project. </translate>
