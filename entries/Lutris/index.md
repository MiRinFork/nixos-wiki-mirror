...
[Lutris](https://lutris.net/) is a video game preservation platform that you can use to play or emulate pretty much any game you want.
...
The Lutris documentation shows [how to make your system esync compatible](https://github.com/lutris/docs/blob/master/HowToEsync.md). These steps can be achieved on NixOS with the config below.
