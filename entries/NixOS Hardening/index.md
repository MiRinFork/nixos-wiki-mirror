...
[linux-hardened](https://github.com/anthraxx/linux-hardened) is a Linux kernel with additional hardening patches applied. You can check for latest releases [here](https://github.com/anthraxx/linux-hardened/releases).
