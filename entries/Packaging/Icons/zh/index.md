...
<!-- Source page: Packaging/Icons/zh -->
...
现已过时的 [scribus v1.4](https://github.com/nixos/nixpkgs/blob/c8e5c5c2228ddd58f01b7229e0bb4a92a9585990/pkgs/applications/office/scribus/1_4.nix) 应用程序的示例代码：
...
`-background none` 将创建透明图标。替代方案`-background white`。

<span id="See_also"></span>

### 另见

处理图标的另一个示例：[obsidian](https://github.com/NixOS/nixpkgs/blob/6d8e9b4f6197f7ce5106069f13debfc8e9b1fa8b/pkgs/applications/misc/obsidian/default.nix#L62)。
