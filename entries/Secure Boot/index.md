...
<!-- Source page: Secure Boot -->

<languages/> <translate> Secure Boot usually refers to a platform firmware capability to verify the boot components and ensure that only your own operating system is allowed to boot.
...
[Arch Wiki/Secure Boot](https://wiki.archlinux.org/title/Unified_Extensible_Firmware_Interface/Secure_Boot) Extensive information on Secure Boot including using UKIs. </translate>
