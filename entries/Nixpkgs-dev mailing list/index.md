...
View the mailing list here: [nixpkgs-dev](https://lists.sr.ht/~andir/nixpkgs-dev)

### How does it work

Submit a patch to nixpkgs using `git send-email`, see [git-send-email.io](https://git-send-email.io) for instructions.
