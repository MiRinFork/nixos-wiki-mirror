...
You can use the following nix-shell script to build the open source PS2SDK through [ps2dev](https://github.com/ps2dev/ps2dev).
...
Playstation 2 use PFS filesystem and APA partitions see [libHdd Reference Manual](https://master.dl.sourceforge.net/project/kernelloader/Sony%20Linux%20Toolkit/Package%20Update%20Files/apa/libhdd_ref.pdf?viasf=1) for more information. You could use pfsshell on PC to create APA partition and format to PFS. pfsshell's author advises you to not use it as root.
...
Extract [this archive](https://web.archive.org/web/20221210004709/https://www.ps2-home.com/forum/download/file.php?id=15758&sid=f956d2accefb993288a6791c7c85a5c0) (wLE_kHn_20200810.7z md5:430af5615895736d96b4f7156e92b2b0 [dl source](https://www.ps2-home.com/forum/viewtopic.php?t=5128)) then call hdl_dump:
...
<a href="Category:Gaming" class="wikilink" title="Category:Gaming">Category:Gaming</a> <a href="Category:Applications" class="wikilink" title="Category:Applications">Category:Applications</a> <a href="Category:Hardware" class="wikilink" title="Category:Hardware">Category:Hardware</a>
