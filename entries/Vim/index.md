...
<languages/> <translate> [Vim](https://www.vim.org/) (vi improved) is a highly configurable modal text editor program for the terminal.
...
import these in your `configuration.nix` and </translate>
