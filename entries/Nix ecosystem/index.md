...
| <a href="Special:MyLanguage/Nix" class="wikilink" title="Nix">Nix</a> | <translate> [Nix Manual](https://nix.dev/manual/nix/)</translate> | <translate> A package manager that parses Nix expressions specifying reproducible builds, putting the result in a store address with a hash of the dependency tree, sidestepping dependency hell and supporting multiversion installs and rollbacks.</translate> | <translate> Reproducible builds & package management in Linux & Darwin</translate> | LGPL-2.1 |
