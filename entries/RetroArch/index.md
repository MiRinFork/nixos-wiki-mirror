...
<!-- Source page: RetroArch -->

[RetroArch](https://www.retroarch.com/) is a all-in-one front-end for emulators, game engines and media players. Nix allows for installing RetroArch cores in a declarative and customizable way.
...
Using `retroarch.withCores`:

One can browse the available cores [here](https://github.com/NixOS/nixpkgs/tree/master/pkgs/applications/emulators/libretro)
...
1.  Fork the [retroarch-joypad-autoconfig](https://github.com/libretro/retroarch-joypad-autoconfig) project and clone it in a folder of your choosing.
...
2.  Now you can create a pull request from your fork to the retroarch-joypad-autoconfig project to upstream your changes.
...
This is because the location of the controller profile is in the nix store, making it read-only. To actually remap a controller, see the <a href="RetroArch#Mapping" class="wikilink" title="Mapping">Mapping</a> section.
