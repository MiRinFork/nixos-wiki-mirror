...
In Nix and NixOS, a user environment is a core concept in understanding how the system operates. This page serves as a quick reference. More documentation is present in parts of the and in the , interspersed with <a href="Python" class="wikilink" title="Python">Python</a> install instructions.
...
> The main command for package management is . You can use it to install, upgrade, and erase packages, and to query what packages are installed or are available for installation.
>
...
>
> <figure>
> <img src="NixManual-User-environments.png" title="NixManual-User-environments.png" />
> <figcaption>NixManual-User-environments.png</figcaption>
> </figure>
>
