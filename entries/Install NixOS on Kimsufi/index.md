...
<!-- Source page: Install NixOS on Kimsufi -->

This guide explains how to install NixOS on [Kimsufi](https://www.kimsufi.com/en/) machines from the rescue system. It is based on [this blog post](https://mgdm.net/weblog/nixos-on-kimsufi/) (with permission) and includes some minor corrections & simplifications. All thanks to Michael Maclean & Graham Christensen for the original post.
