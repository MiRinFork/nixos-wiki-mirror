...
<!-- Source page: Hardware/GPD/GPD Pocket -->

The following configuration bits are required for a GPD Pocket device.
...
`{`  
`  imports = [`  
`    # generated by nixos-generate-config on installation`  
`    <nixpkgs/nixos/modules/installer/scan/not-detected.nix>`  
  
`    # Device specific`  
`    "${configDir}/etc/gpd/kernel.nix"`  
`  ];`  
...
`    kernelModules = [ "btusb" "kvm-intel" ]; # bluetooth`  
