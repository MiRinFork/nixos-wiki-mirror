...
この記事はNixのために且つNixを使ってビルドされたアプリケーションの一覧で、いわゆる***拡張Nixエコシステム***と呼ばれているものの一覧を構成しています (Nixの中核エコシステムは<a href="Special:MyLanguage/Nix_Ecosystem" class="wikilink" title="Nix Ecosystem">Nix Ecosystemを</a>参照)。

<div class="mw-translate-fuzzy">

もしLinuxソフトウェアかLinuxアプリケーションを探しているならば、<a href=":Category:Software" class="wikilink" title="Software">Softwareか</a>、<a href=":Category:Software" class="wikilink" title="Applications">Applicationsを</a>読むと良いでしょう。

</div>

<span id="Non-NixOS_Distributions"></span> NixOSでないディストリビューション
