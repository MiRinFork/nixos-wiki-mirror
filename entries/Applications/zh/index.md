...
本文列出了为 Nix 设计或使用 Nix 构建的各类应用程序；它们共同构成了可称之为***扩展 Nix 生态系统***的内容（关于核心 Nix 生态系统，请参见 <a href="Special:MyLanguage/Nix_Ecosystem" class="wikilink" title="Nix Ecosystem">Nix Ecosystem</a>）。

如果你在寻找 Linux 软件或应用程序，请参阅 <a href=":Category:Software" class="wikilink" title="软件">软件</a>。
