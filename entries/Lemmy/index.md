...
[](https://join-lemmy.org/) ([wikipedia](https://en.wikipedia.org/wiki/Lemmy_(software))) is a link aggregator for the fediverse.
...
This article is an extension to the documentation in the [NixOS manual](https://nixos.org/manual/nixos/stable/#module-services-lemmy).
...
- [Official Documentation](https://join-lemmy.org/docs/en/index.html)
