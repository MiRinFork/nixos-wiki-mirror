...
<!-- Source page: Nixpkgs/en -->

<languages/> **Nixpkgs** is the largest repository of <a href="Nix" class="wikilink" title="Nix">Nix</a> packages and <a href="NixOS" class="wikilink" title="NixOS">NixOS</a> modules. The repository is [hosted on GitHub](https://github.com/nixos/nixpkgs) and maintained by the community, with official backing from the <a href="NixOS_Foundation" class="wikilink" title="NixOS Foundation">NixOS Foundation</a>.
